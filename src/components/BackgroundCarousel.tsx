...
export const BackgroundCarousel: React.FC = () => {
  ...
  return (
    <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
      ...
      {/* Layered subtle gradients: protects readability and lets Pedro shine from head to boots */}
      <div className="absolute inset-0 bg-slate-950/45" />
      <div className="absolute inset-0 bg-gradient-to-b from-slate-950/80 via-transparent to-slate-950/70" />
      <div className="absolute bottom-0 left-0 right-0 h-72 bg-gradient-to-t from-slate-950 via-slate-950/90 to-transparent" />
    </div>
  );
};
